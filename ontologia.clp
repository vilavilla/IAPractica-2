...
(definstances instances
    ...
    ([Historico] of Tematica
         (tematica_tiene_obra  [La_Libertad_Guiando_al_Pueblo] [La_Momia] [La_consagracion_de_Napoleon])
    )

    ([Histórico] of Tematica
         (tematica_tiene_obra  [Guernica])
    )
    ...
    ([Johannes_Vermeer] of Pintor
         ...
         (Nacionalidad  "Holandes" "Holandés")
    ...
    ([La_Momia] of Obra
         ...
         (obra_tiene_pintor  [Desconocido])
         (obra_tiene_tematica  [Historico])
         (Complejidad  2 "La momia")
         (Dimensiones_alto  -2500 160)
         (Importancia  2)
         (Sala  1)
    )
    ...
    ([Nighthawks] of Obra
         ...
         (obra_tiene_tematica  [Soledad] [Urbano])
         (Complejidad  4)
         (Data_creacion  1942)
         (Dimensiones_alto  80)
